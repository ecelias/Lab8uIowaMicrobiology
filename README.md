...
**Please note, if using the app from the above link, it was deployed on a free shinyapps.io plan so if usage exceeds 25 hours per month, the app will not be available. 
